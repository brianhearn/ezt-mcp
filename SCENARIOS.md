...
- Should visit frequency column be specified in `ingest_accounts` (attached to the point layer schema) or in `auto_build_territory_solution` (specified at build time)? Former seems cleaner — it is a property of the account, not the build.
